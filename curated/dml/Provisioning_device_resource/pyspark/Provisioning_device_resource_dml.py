...
# Generated on: 2025-08-26T09:30:54.436Z
...
spark = SparkSession.builder \
    .appName("Provisioning_device_resource_DML_Operations") \
    .config("spark.sql.adaptive.enabled", "true") \
    .getOrCreate()

# Read raw data
raw_df = spark.read.parquet("path/to/raw/Provisioning_device_resource")

# Read existing curated data
curated_df = spark.read.parquet("path/to/curated/Provisioning_device_resource")
...
if new_records.count() > 0:
    ...
    transformed_new.write.mode("append").parquet("path/to/curated/Provisioning_device_resource")
...
if existing_records.count() > 0:
    ...
    updated_records.write.mode("overwrite").parquet("path/to/curated/Provisioning_device_resource_updated")
...
if deleted_records.count() > 0:
    ...
    deleted_records.write.mode("append").parquet("path/to/curated/Provisioning_device_resource_deleted")
