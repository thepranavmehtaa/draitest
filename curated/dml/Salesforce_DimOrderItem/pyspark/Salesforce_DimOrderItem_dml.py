...
# Generated on: 2025-08-26T11:31:29.645Z
...
spark = SparkSession.builder \
    .appName("Salesforce_DimOrderItem_DML_Operations") \
    .config("spark.sql.adaptive.enabled", "true") \
    .getOrCreate()

# Read raw data
raw_df = spark.read.parquet("path/to/raw/Salesforce_DimOrderItem")

# Read existing curated data
curated_df = spark.read.parquet("path/to/curated/Salesforce_DimOrderItem")
...
if new_records.count() > 0:
    ...
    transformed_new.write.mode("append").parquet("path/to/curated/Salesforce_DimOrderItem")
...
if existing_records.count() > 0:
    ...
    updated_records.write.mode("overwrite").parquet("path/to/curated/Salesforce_DimOrderItem_updated")
...
if deleted_records.count() > 0:
    ...
    deleted_records.write.mode("append").parquet("path/to/curated/Salesforce_DimOrderItem_deleted")
