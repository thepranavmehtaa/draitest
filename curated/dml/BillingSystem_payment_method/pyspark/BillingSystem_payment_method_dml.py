...
# Generated on: 2025-08-26T11:31:20.301Z
...
spark = SparkSession.builder \
    .appName("BillingSystem_payment_method_DML_Operations") \
    .config("spark.sql.adaptive.enabled", "true") \
    .getOrCreate()

# Read raw data
raw_df = spark.read.parquet("path/to/raw/BillingSystem_payment_method")

# Read existing curated data
curated_df = spark.read.parquet("path/to/curated/BillingSystem_payment_method")
...
if new_records.count() > 0:
    ...
    transformed_new.write.mode("append").parquet("path/to/curated/BillingSystem_payment_method")
...
if existing_records.count() > 0:
    ...
    updated_records.write.mode("overwrite").parquet("path/to/curated/BillingSystem_payment_method_updated")
...
if deleted_records.count() > 0:
    ...
    deleted_records.write.mode("append").parquet("path/to/curated/BillingSystem_payment_method_deleted")
