...
# Generated on: 2025-08-29T10:31:00.620Z
...
spark = SparkSession.builder \
    .appName("CatalogDB_product_DML_Operations") \
    .config("spark.sql.adaptive.enabled", "true") \
    .getOrCreate()

# Read raw data
raw_df = spark.read.parquet("path/to/raw/CatalogDB_product")

# Read existing curated data
curated_df = spark.read.parquet("path/to/curated/CatalogDB_product")
...
if new_records.count() > 0:
    ...
    transformed_new.write.mode("append").parquet("path/to/curated/CatalogDB_product")
...
if existing_records.count() > 0:
    ...
    updated_records.write.mode("overwrite").parquet("path/to/curated/CatalogDB_product_updated")
...
if deleted_records.count() > 0:
    ...
    deleted_records.write.mode("append").parquet("path/to/curated/CatalogDB_product_deleted")
